...
def new_transaction_page(page: ft.Page, view: ft.View):
    ...
    dlg = ft.AlertDialog(
        title=ft.Text("Billing order", size=30,
        ...
        content=ft.Column([
            ft.Row([
                ...
                ft.Text(f"Order date : {formatted_date}",
                        weight="bold"),
            ]),
            ft.Text("Your order: ", weight="bold", size=25),
        ...
        actions=[
            ...
            vw_cartlist,
            ft.Text('TOTAL: ', weight="bold", size=30),
            vw_total,
            ft.ElevatedButton("Place Order",
                ...
                ft.Column(col=3,
                          ...
                          controls=[
                              ft.Column(controls=[
                                  ...
                                  vw_total,
                                  ft.FilledButton(
                                      'CHECKOUT', width=1000, on_click=open_checkout),
                              ]),
